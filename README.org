...
I have three Emacs configurations at the moment:

- the one you're currently looking at, which I use on my private machines on Windows 10, Linux and WSL,
- a forked variant that I use in my day job, which has kinda grown too much (Windows 11), and
